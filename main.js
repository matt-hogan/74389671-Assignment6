...
const pizza = {
    crust: "thin",
    setCrust (crustType) { this.crust = crustType; }
};
...
function introduceTheActors (actorArray) {
    ...
    actorArray.forEach(actor => {
        actorStatement.push(`Hi, I'm ${actor.name} and I was in ${actor.movie}.`);
    });
...
const techCompanies = {
    ...
    founderLookup (companyName) { return this[companyName]; }
};
...
Object.assign(blueBerryPie, {
    taste () { return "Delicious!"; }
});